...
app_dash = Dash(__name__,  external_stylesheets=[dbc.themes.LUMEN],  routes_pathname_prefix='/test_dash1/')
...
app_dash = setup(app_dash)

if __name__ == '__main__':
    app_dash.run_server(host='0.0.0.0', port=1234, debug=True)